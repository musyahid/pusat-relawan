      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
             <div class="box-header">
              <tbody>
             <h3>Detail Pengajuan Forum <span class="badge badge-secondary"><?=$pengajuan_forum[0]->nama_forum ?></span></h3>
              </tbody>
            </div>
        <table class="table table-striped">
            ...
            <tr>
              <td colspan="5"> 
                <center>
                    <a href="<?php echo base_url() ?>admin/forum_relawan/acc_pengajuan?id_forum=<?php echo $pengajuan_forum[0]->id_forum; ?>" class="btn btn-sm btn-success"> <span class="" aria-hidden="true"></span> SETUJUI</a>
                </center>
              </td>
            </tr>
        </table>
